...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(RecommendationService, [{
        ...
        value: function getFlights(sourceLocation, totalBudget, vacationPref) {
          var flights = _Mocks_mock_flights__WEBPACK_IMPORTED_MODULE_5__["FLIGHTS"].filter(function (x) {
            return x.sourceCity == sourceLocation;
          });
        ...
        value: function getHotel(destinationLocation, totalBudget, vacationPref) {
          var hotels = _Mocks_mock_hotels__WEBPACK_IMPORTED_MODULE_6__["HOTELS"].filter(function (x) {
            return x.city == destinationLocation;
          });
        ...
        value: function getCar(destinationLocation, totalBudget, vacationPref) {
          var cars = _Mocks_mock_car__WEBPACK_IMPORTED_MODULE_7__["CARS"].filter(function (x) {
            return x.pickUpLocation == destinationLocation;
          });
  ...
  function srcAppToursListToursListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ToursListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 5,
      consts: [[1, "col-lg-3", "col-md-4", "col-sm-6", "col-xs-12", "center-this-pls"], [1, "col-min", "text-header"], ["contenteditable", "true"], ["class", "col-lg-3 col-md-4 col-sm-6 col-xs-12 repeated-item", 4, "ngFor", "ngForOf"], [1, "col-lg-3", "col-md-4", "col-sm-6", "col-xs-12", "repeated-item"], [1, "home-card", 3, "click"], [1, "home-card-content"], ["mat-card-image", "", 3, "src", "alt"], [1, "trip-cost"]],
